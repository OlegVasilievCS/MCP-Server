...
@mcp.tool()
def add_ai_research_summary_to_issue_comment(summary: str, description: str):
    """Adds a summary of the issues technical solution, generated by AI"""
    response = tavily_client.search("Who is Leo Messi?")
    logger.info(f"Adding technical summary")
    return jira.add_research_comment(issue_key, research_data)
